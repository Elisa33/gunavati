...
export default function ComingSoon() {
  return (
    <main className="min-h-dvh bg-black bg-[url(/img/bg-mobile.jpeg)] md:bg-[url(/img/bg-desktop-flip.png)] bg-cover bg-center flex flex-col md:flex-row text-white w-full overscroll-none">
